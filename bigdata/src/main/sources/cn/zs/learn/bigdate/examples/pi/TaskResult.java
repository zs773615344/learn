...
public class TaskResult implements Container<Summation>, Combinable<TaskResult>, Writable {
  ...
  public String toString() {
    return "sigma=" + sigma + ", duration=" + duration + "(" + cn.zs.learn.bigdate.examples.pi.Util.millis2String(duration) + ")";
  }
  ...
  public static TaskResult valueOf(String s) {
    ...
    final Summation sigma = Summation.valueOf(cn.zs.learn.bigdate.examples.pi.Util.parseStringVariable("sigma", s.substring(i, j)));
