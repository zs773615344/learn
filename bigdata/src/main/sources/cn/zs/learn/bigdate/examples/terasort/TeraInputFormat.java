...
import cn.zs.learn.bigdate.examples.terasort.TeraScheduler;
...
public class TeraInputFormat extends FileInputFormat<Text,Text> {
  ...
  public List<InputSplit> getSplits(JobContext job) throws IOException {
    ...
    if (job.getConfiguration().getBoolean(cn.zs.learn.bigdate.examples.terasort.TeraScheduler.USE, true)) {
      cn.zs.learn.bigdate.examples.terasort.TeraScheduler scheduler = new cn.zs.learn.bigdate.examples.terasort.TeraScheduler(
