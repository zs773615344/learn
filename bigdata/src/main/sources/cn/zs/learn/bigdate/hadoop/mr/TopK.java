...
public class TopK {
	...
	public static void main(String[] args) {
		...
		try {
			...
			FileInputFormat.setInputPaths(job, new Path("hdfs://192.168.8.91:9000/user/hadoop/p1.txt"));
			FileOutputFormat.setOutputPath(job, new Path("hdfs://192.168.8.91:9000/user/hadoop/out55"));
