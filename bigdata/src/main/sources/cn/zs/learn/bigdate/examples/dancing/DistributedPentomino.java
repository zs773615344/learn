...
package cn.zs.learn.bigdate.examples.dancing;

import java.io.*;
import java.util.List;
import java.util.StringTokenizer;

import cn.zs.learn.bigdate.examples.dancing.OneSidedPentomino;
import cn.zs.learn.bigdate.examples.dancing.Pentomino;
import org.apache.hadoop.conf.Configuration;
import org.apache.hadoop.conf.Configured;
import cn.zs.learn.bigdate.examples.dancing.DancingLinks;
import cn.zs.learn.bigdate.examples.dancing.OneSidedPentomino;
import cn.zs.learn.bigdate.examples.dancing.Pentomino;
...
public class DistributedPentomino extends Configured implements Tool {
  ...
  public static class PentMap extends 
    ...
    private int height;
    private int depth;
    private cn.zs.learn.bigdate.examples.dancing.Pentomino pent;
    ...
    implements DancingLinks.SolutionAcceptor<cn.zs.learn.bigdate.examples.dancing.Pentomino.ColumnName> {
      public void solution(List<List<cn.zs.learn.bigdate.examples.dancing.Pentomino.ColumnName>> answer) {
        String board = cn.zs.learn.bigdate.examples.dancing.Pentomino.stringifySolution(width, height, answer);
        try {
    ...
    public void setup(Context context) {
      ...
      depth = conf.getInt(cn.zs.learn.bigdate.examples.dancing.Pentomino.DEPTH, PENT_DEPTH);
      width = conf.getInt(cn.zs.learn.bigdate.examples.dancing.Pentomino.WIDTH, PENT_WIDTH);
      height = conf.getInt(cn.zs.learn.bigdate.examples.dancing.Pentomino.HEIGHT, PENT_HEIGHT);
      pent = (cn.zs.learn.bigdate.examples.dancing.Pentomino)
        ReflectionUtils.newInstance(conf.getClass(cn.zs.learn.bigdate.examples.dancing.Pentomino.CLASS,
                                                  cn.zs.learn.bigdate.examples.dancing.OneSidedPentomino.class),
                                    conf);
  ...
  private static long createInputDirectory(FileSystem fs, 
                                           Path dir,
                                           cn.zs.learn.bigdate.examples.dancing.Pentomino pent,
                                           int depth
                                           ) throws IOException {
    fs.mkdirs(dir);
  ...
  public int run(String[] args) throws Exception {
    ...
    int width = conf.getInt(cn.zs.learn.bigdate.examples.dancing.Pentomino.WIDTH, PENT_WIDTH);
    int height = conf.getInt(cn.zs.learn.bigdate.examples.dancing.Pentomino.HEIGHT, PENT_HEIGHT);
    int depth = conf.getInt(cn.zs.learn.bigdate.examples.dancing.Pentomino.DEPTH, PENT_DEPTH);
    ...
    conf.setInt(cn.zs.learn.bigdate.examples.dancing.Pentomino.WIDTH, width);
    conf.setInt(cn.zs.learn.bigdate.examples.dancing.Pentomino.HEIGHT, height);
    conf.setInt(cn.zs.learn.bigdate.examples.dancing.Pentomino.DEPTH, depth);
    Class<? extends cn.zs.learn.bigdate.examples.dancing.Pentomino> pentClass = conf.getClass(cn.zs.learn.bigdate.examples.dancing.Pentomino.CLASS,
      OneSidedPentomino.class, cn.zs.learn.bigdate.examples.dancing.Pentomino.class);
