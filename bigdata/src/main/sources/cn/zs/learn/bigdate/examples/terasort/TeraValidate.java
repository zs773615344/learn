...
public class TeraValidate extends Configured implements Tool {
  ...
  static class ValidateMapper extends Mapper<Text,Text,Text,Text> {
    ...
    private cn.zs.learn.bigdate.examples.terasort.Unsigned16 tmp = new cn.zs.learn.bigdate.examples.terasort.Unsigned16();
  ...
  static class ValidateReducer extends Reducer<Text,Text,Text,Text> {
    ...
    public void reduce(Text key, Iterable<Text> values,
      ...
      if (ERROR.equals(key)) {
        ...
        cn.zs.learn.bigdate.examples.terasort.Unsigned16 tmp = new cn.zs.learn.bigdate.examples.terasort.Unsigned16();
